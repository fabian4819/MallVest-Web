...
import RevenueOracle from "./json/RevenueOracle.json";
import { ContractType, ABISingle, AvailableContracts } from "./types";

// RevenueOracle deployed at ETH Sepolia Test Net: Contract Address: 0xbAbb5d8F2127EB8C536534258dE6e3959a473bC1
// == Logs ==
...
const contracts: ContractType[] = [
  ...
  {
    name: "RevenueOracle",
    address: "0xbAbb5d8F2127EB8C536534258dE6e3959a473bC1",
    abi: RevenueOracle.abi as ABISingle[]
  }
];
